...
def main() -> None:
    ...
    if args.allow_component_ablation:
        # Component profiles may explicitly shorten early stopping for a
        # resumed screening run, but no other optimizer or model setting is
        # admitted outside the predeclared ablation switches.
        allowed = {"p23_profile", "use_patient_relative_z", "patience"}
