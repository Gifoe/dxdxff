...
def _rtc_resume_contract(args: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "p23_seizure_quantile": float(getattr(args, "p23_seizure_quantile", 0.10)),
...
def run_p23_trn(experiment: Any) -> list[dict[str, Any]]:
    ...
    if is_formal_p2_variant:
        ...
        tail_columns = [
            name for name in (
                "seizure_nez_probability_tail_quantile", "seizure_tail_quantile", "seizure_nez_robust_tail_logit",
    ...
    channels.groupby(["outer_fold", "center"], as_index=False)[["seizure_nez_probability_tail_quantile", "seizure_tail_quantile", "seizure_agreement", "u_seizure"]].mean().to_csv(output / "p23_seizure_tail_diagnostics.csv", index=False)
