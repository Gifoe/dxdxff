...
$Arguments = @(
    ...
    "--output_dir", $env:DRE_TASK2_MOSAIC_NO_FRAGILITY_OUTPUT_DIR,
    "--pilot_size", "16", "--patients_per_center", "4", "--batch_size", "32",
    "--seed", "42", "--bootstrap_repeats", "2000", "--n_jobs", "8", "--biomarker_workers", "4",
    "--strict", "--resume", "--disable_fragility"
)
