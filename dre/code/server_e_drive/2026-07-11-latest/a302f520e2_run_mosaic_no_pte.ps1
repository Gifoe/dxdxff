...
# Paired PTE ablation: preserves Fragility, Recruitment, Spectral, NEZ,
# fixed pilot folds, full LOPO expert cross-fitting, and the meta model.
$Arguments = @(
    ...
    "--output_dir", $env:DRE_TASK2_MOSAIC_NO_PTE_OUTPUT_DIR,
