...
# Complete original fixed five-fold cohort. Fragility and PTE/CII are disabled;
# Recruitment, Spectral, frozen P2 OOF, LOPO cross-fitting, and meta fusion remain.
$Arguments = @(
    ...
    "--output_dir", $env:DRE_TASK2_MOSAIC_FULL_NO_FRAGILITY_NO_PTE_OUTPUT_DIR,
    "--full_cohort", "--batch_size", "32", "--seed", "42",
    "--bootstrap_repeats", "2000", "--n_jobs", "8", "--biomarker_workers", "4",
    "--strict", "--resume", "--disable_fragility", "--disable_pte"
)
