...
def load_checkpoint(
    ...
    *,
    ...
    return CheckpointState(int(payload["epoch"]), float(payload["best_metric"]), dict(payload.get("extra") or {}))


__all__ = ["CheckpointState", "load_checkpoint", "save_checkpoint_atomic"]
